...
const Details: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      try {
        console.log('Starting ad loading process for Details page');
        loadAdScript('details-ad-1', '7d2d7ee660ee84c91c4fff9fb4eb32f9', 320, 50);
        loadAdScript('details-ad-2', 'f4740102a4fd064713bb883f226e1d5f', 468, 60);
        loadAdScript('details-ad-3', 'feccc4e460df1f1b7bb9d0ba6836c200', 160, 600);
      } catch (error) {
            ...
            <div className="w-full advertisement-section" data-auto-click-ad>
              <Card className="bg-gradient-to-br from-black/40 via-[#0A7D4B]/10 to-black/40 backdrop-blur-sm border border-border/30">
                <CardContent className="p-4 sm:p-6 space-y-6 sm:space-y-8">
                  {/* First Ad - 320x50 Mobile Banner */}
                  <div className="w-full flex justify-center">
                    <div className="w-full max-w-sm min-h-[70px] bg-gray-900/20 rounded-lg p-4 flex items-center justify-center">
                      <div id="details-ad-1" className="w-full h-full flex items-center justify-center"></div>
                    </div>
                  </div>

                  {/* Second Ad - 468x60 Banner */}
                  <div className="w-full flex justify-center">
                    <div className="w-full max-w-lg min-h-[80px] bg-gray-900/20 rounded-lg p-4 flex items-center justify-center">
                      <div id="details-ad-2" className="w-full h-full flex items-center justify-center"></div>
                    </div>
                  </div>

                  {/* Third Ad - 160x600 Wide Skyscraper - Centered */}
                  <div className="w-full flex justify-center">
                    <div className="w-full max-w-xs min-h-[620px] bg-gray-900/20 rounded-lg p-4 flex items-center justify-center">
                      <div id="details-ad-3" className="w-full h-full flex items-center justify-center"></div>
                    </div>
                  </div>
                </CardContent>
              </Card>
